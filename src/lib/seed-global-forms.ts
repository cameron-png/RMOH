...
// This is a script to seed your Firestore database with the initial global forms.
// To run this script, you'll need to install ts-node: `npm install -g ts-node`
// Then, you can run it from your project root: `ts-node --esm src/lib/seed-global-forms.ts`
...
const globalForms: Omit<FeedbackForm, 'id'>[] = [
  {
...
async function seedForms() {
  ...
  console.log('Checking for existing global forms and adding new ones...');
